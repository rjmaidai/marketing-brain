...
// Realistic appearance data per head ID
const HEAD_VISUALS: Record<string, {
    ...
    S2: { skinTone:"#f0d0a0",skinMid:"#d8a060",skinDark:"#b07030",hairColor:"#1a1a1a",hairStyle:"short",eyeColor:"#3a3a5a",hasBeard:false,hasGlasses:true,gender:"m",age:"mid" },
    S3: { skinTone:"#fde8c8",skinMid:"#e8b880",skinDark:"#c08050",hairColor:"#6a4020",hairStyle:"short",eyeColor:"#604020",hasBeard:false,hasGlasses:false,gender:"m",age:"senior" },
    S4: { skinTone:"#ffe0c0",skinMid:"#e8b070",skinDark:"#c07840",hairColor:"#2a2010",hairStyle:"short",eyeColor:"#3a5030",hasBeard:false,hasGlasses:true,gender:"m",age:"mid" },
    S5: { skinTone:"#fde8cc",skinMid:"#e0b070",skinDark:"#b87840",hairColor:"#4a3820",hairStyle:"bald",eyeColor:"#404040",hasBeard:false,hasGlasses:true,gender:"m",age:"senior" },
    // AUDIENCE
    A1: { skinTone:"#f5d5a0",skinMid:"#d8a058",skinDark:"#a87030",hairColor:"#3a2a10",hairStyle:"short",eyeColor:"#503020",hasBeard:false,hasGlasses:false,gender:"m",age:"senior" },
    ...
    A3: { skinTone:"#fde0b8",skinMid:"#e0a860",skinDark:"#b87838",hairColor:"#0a0a0a",hairStyle:"bald",eyeColor:"#2a2a2a",hasBeard:false,hasGlasses:false,gender:"m",age:"senior" },
    ...
    // DISTRIBUTION
    D1: { skinTone:"#f0d0a0",skinMid:"#d8a060",skinDark:"#b07030",hairColor:"#1a1a1a",hairStyle:"bald",eyeColor:"#3a3020",hasBeard:true,beardColor:"#1a1a1a",hasGlasses:false,gender:"m",age:"mid" },
    ...
    D3: { skinTone:"#f5d8b0",skinMid:"#e0a860",skinDark:"#b07030",hairColor:"#0a0a0a",hairStyle:"short",eyeColor:"#2a2a2a",hasBeard:false,hasGlasses:false,gender:"m",age:"young" },
    ...
    C4: { skinTone:"#ffe8c8",skinMid:"#e8b870",skinDark:"#c08840",hairColor:"#1a1a1a",hairStyle:"short",eyeColor:"#3a3020",hasBeard:true,beardColor:"#1a1a1a",hasGlasses:false,gender:"m",age:"young" },
    ...
    // SOCIAL MEDIA
    "01": { skinTone:"#e8c090",skinMid:"#c89050",skinDark:"#a07030",hairColor:"#1a1010",hairStyle:"bald",eyeColor:"#2a1a0a",hasBeard:true,beardColor:"#1a1010",hasGlasses:false,gender:"m",age:"mid" },
    ...
    // INFLUENCER
    I1: { skinTone:"#ffe0c0",skinMid:"#e8b068",skinDark:"#c07838",hairColor:"#1a1a1a",hairStyle:"short",eyeColor:"#2a2a3a",hasBeard:false,hasGlasses:false,gender:"m",age:"mid" },
    ...
    I4: { skinTone:"#e8c090",skinMid:"#c89050",skinDark:"#a07030",hairColor:"#1a1010",hairStyle:"bald",eyeColor:"#2a1a0a",hasBeard:true,beardColor:"#1a1010",hasGlasses:false,gender:"m",age:"mid" },
...
export function HeadAvatar({ id, name, color, size = "md", isSpeaking, isMuted }: HeadAvatarProps) {
  ...
  return (
        <div
                className={`ha-root relative inline-flex items-center justify-center rounded-full overflow-hidden ${isSpeaking ? "ha-speaking" : ""} ${isMuted ? "opacity-40 saturate-50" : ""}`}
                style={{
                          width: px, height: px,
              ...
              <svg viewBox="0 0 100 100" width={px} height={px} aria-hidden>
                ...
                {/* Segment color accent  -  thin border ring */}
