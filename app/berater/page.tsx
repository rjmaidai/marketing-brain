...
export const metadata = {
  ...
  description:
    "Ein Echtzeit-Videoberater, hinter dem 51 Marketing-Köpfe urteilen. Schildern Sie Ihr Anliegen, hören Sie eine klare Empfehlung.",
};
    ...
    <main className="min-h-screen px-4 py-10 max-w-6xl mx-auto flex flex-col">
      <header className="mb-8 text-center">
        ...
        <p className="mx-auto max-w-xl text-sm leading-relaxed text-muted">
          ...
          Berater urteilen 51 Marketing-Köpfe (inkl. Schweizer Perspektive). Sie
          bekommen kein Gremiums-Wirrwarr,
      ...
      <footer className="mt-12 flex items-center justify-center gap-4 pt-8 text-[11px] uppercase tracking-[0.18em] text-muted">
        <Link href="/" className="transition hover:text-ink">
          ← Zum Gremium (51 Köpfe im Streit)
        </Link>
      </footer>
    </main>
  );
